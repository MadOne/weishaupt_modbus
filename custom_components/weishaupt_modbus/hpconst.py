...
IO_KONFIG_IN: list[StatusItem] = [
    ...
    StatusItem(6, "Not-Aus:", description="Wärmepumpe, Elektroheizung und Pumpe aus."),
    StatusItem(7, "System Standby:", description="Standby"),
    StatusItem(
        8, "Erzeugersperre HZ:", description="Heizkreis durch Wärmepumpe gesperrt."
    ),
    StatusItem(
        9,
        "Erzeugersperre WW:",
    ...
    StatusItem(11, "Warmwasser Standby:", description="Warmwasserladung Standby."),
    StatusItem(
        12, "Warmwasser Absenk:", description="Warmwasserladung im Absenkbetrieb."
    ),
    StatusItem(
        13, "Warmwasser Normal:", description="Warmwasserladung im Normalbetrieb."
    ),
    StatusItem(
        14,
        "Warmwasser PUSH:",
    ...
    StatusItem(
        15, "Taupunktwächter", description="Kühlbetrieb für Heizkreise gesperrt."
    ),
    StatusItem(16, "Heizkreis … Standby:", description="Heizkreis im Standby."),
    StatusItem(17, "Heizkreis … Absenk:", description="Heizkreis im Absenkbetrieb"),
    StatusItem(18, "Heizkreis … Normal:", description="Heizkreis im Normalbetrieb."),
    StatusItem(19, "Heizkreis … Komfort:", description="Heizkreis im Komfortbetrieb"),
    StatusItem(20, "2.WEZ", description="2. Wärmeerzeuger über Eingang aktivieren."),
    StatusItem(
        21,
        "Sperre Verdichter:",
        description="Externe Vorgabe zur Sperre vom Verdichter.ng für Digitaleingang DE",
    ),
    StatusItem(65535, "AUS", description="Keine Funktion, wird nicht angesteuert."),
]
