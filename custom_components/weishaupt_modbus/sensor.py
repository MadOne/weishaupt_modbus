...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            ...
            Heating_today(host, port),
            Heating_yesterday(host, port),
            Heating_month(host, port),
            Heating_year(host, port),
            Water_today(host, port),
            Water_yesterday(host, port),
            Water_month(host, port),
            Water_year(host, port),
